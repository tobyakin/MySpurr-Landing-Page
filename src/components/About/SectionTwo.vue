...
<script setup>
import { ref } from 'vue'
import ImageTwo from '@/assets/img/unlock.webp'
import ImageThree from '@/assets/img/empower.webp'
...
const section4List2 = ref([
  {
    text: 'At MySpurr, our mission is clear: to empower creative talents from all corners of the globe. We believe in the transformative power of creativity and its ability to shape lives.'
  },
  {
    text: ' Our platform is dedicated to fostering a thriving creative community, connecting talents with opportunities, and fueling their aspirations.'
  }
])
