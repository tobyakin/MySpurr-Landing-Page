<template>
  <div
    class="bg-[#D3DA51] flex lg:flex-row hidden flex-col gap-6 justify-between items-center p-8 rounded-[13.891px]"
  >
    <p class="font-Satoshi400 text-[#000000] text-[31.025px] lg:leading-[59.23px]">
