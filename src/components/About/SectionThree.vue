<template>
  <div class="container">
    <div class="flex justify-center">
      <h2
        class="text-[#007582] text-[43px] lg:text-[50px] !font-semibold leading-[70px] lg:leading-[70px] font-EBGaramond500 mb-20"
      >
        MySpurr Stories
      </h2>
    </div>
    <div class="flex lg:flex-row flex-col gap-8 pt-[40px]">
