...
const events = [
    {
        ...
        address: 'online',
        event_date: '22nd May 2024',
        event_time: '06:00pm-7:00pm',
    },
    {
        id: 2,
        title: 'Creating your professional workspace with low budget',
            ...
            <section class="w-[80%] eventBreak:w-[90%] mx-auto mt-[4rem]" v-else>
                <article class="flex justify-between flex-col md:flex-row gap-[4.65rem] msgTab:gap-[2rem] items-end">
                    <div class="flex flex-col gap-4 w-full md:w-3/6">
                        ...
                        <p class="text-[#000] font-Satoshi400 text-4 leading-5">Learn how to design your workspace with minimal budget</p>
                        <div class="md:hidden rounded-[2.1875rem] h-full min-h-[300px] msgMob:min-h-[auto] w-full md:w-3/6">
                            <div class="h-full rounded-[2.1875rem] overflow-hidden msgMob:rounded-[0.5rem]">
                                <img src="../../assets/img/event_detail_img.png" alt="event image"
                        ...
                        <div
                            ...
                            <div class="schedule flex flex-col gap-4 eventBreak1:gap-[0.5rem]">
                                <div>
                                    ...
                                    <h3 id="date" class="">22ND MAY, 2024</h3>
                                </div>
                                <div>
                    ...
                    <div class="w-[50%] msgTab:w-full">
                            ...
                            <div class="mb-[3.5rem]">
                                ...
                                <div class="mt-6 eventBreak1:mt-4 flex items-center gap-6">
                                    <div class="w-[4rem] h-[4rem] rounded-[100%] overflow-hidden">
                                        <img src="../../assets/img/anchor_img.png" alt="" class="w-full h-full" />
                                    </div>
                                    <div>
                                        <h3 class="font-Satoshi700 text-[#000] text-4 leading-4 eventBreak1:text-[0.9rem]">
                                            Adedire Akanji
                                        </h3>
                                        <p class="text-sm font-normal">LinkedIn Marketing Specialist</p>
                                        <div class="mt-3 cursor-pointer">
                                            <a href="#" target="_blank" class="mt-[0.2rem]">
                        ...
                        <article class="msgMob:w-full">
                            ...
                            <div class="flex gap-[1.4rem] flex-wrap mt-[1.7rem] msgMob:justify-center">
                                ...
                                >
                                    <img src="../../assets/img/spons1.png" alt="" class="object-fit" />
                                </div>
                                <div class="w-[4rem] h-[4rem] overflow-hidden"
                                >
                                    <img src="../../assets/img/spons2.png" alt="" class="object-fit" />
                                </div>
                                <div class="w-[4rem] h-[4rem] overflow-hidden"
                                >
                                    <img src="../../assets/img/spons3.png" alt="" class="object-fit" />
                                </div>
                                <div class="w-[4rem] h-[4rem] overflow-hidden"
                                >
                                    <img src="../../assets/img/spons4.png" alt="" class="object-fit" />
                                </div>
                                <div class="w-[4rem] h-[4rem] overflow-hidden"
                                >
                                    <img src="../../assets/img/spons1.png" alt="" class="object-fit" />
                                    ...
                                    <form @submit.prevent="handleRegisterNotification" action="" class="w-[82%] mx-auto mt-[2.02rem]">
                                        <div class="form_center flex flex-col gap-[1.5rem]">
                                            <div class="inputField w-full">
                                                ...
                                                class="rounded-[1.0625rem] border-2 border-[#fff] px-[1.13rem] py-[0.9rem] text-[#fff] font-Satoshi500 leading-[0.887rem] text-[1rem] w-full bg-inherit"
                                                >
                                            </div>
                                            <div class="inputField w-full">
                                            ...
                                            <div class="inputField w-full">
                                                <input type="text" placeholder="Cretive Profession"
                                                 class="rounded-[1.0625rem] border-2 border-[#fff] px-[1.13rem] py-[0.9rem] text-[#fff] font-Satoshi500 leading-[0.887rem] text-[1rem] w-full bg-inherit"
                                                >
                                            </div>
                                            <div class="inputField w-full">
                                            ...
                                            <div class="inputField w-full">
                                               <textarea name="" id="" 
                                               placeholder="Do you have any specific questions you’d want the speaker to address?"
                                               class="rounded-[1.0625rem] border-2 border-[#fff] px-[1.13rem] py-[0.8rem] text-[#fff] font-Satoshi500 leading-[0.887rem] text-[1rem] w-full bg-inherit h-[9rem]" ></textarea>
                                            </div>
                                        </div>
                    ...
                    <div class="eventAds-container grid grid-cols-customGrid gap-6 my-10">
                        <article v-for="event in events" :key="event.id"
                            ...
                            <div class="rounded-t-[1rem]">
                                <img src="../../assets/img/event_img.png" alt=""
