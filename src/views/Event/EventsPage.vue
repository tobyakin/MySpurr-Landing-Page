    ...
    <section>
        ...
        <main>
            <header class="mb-[9.75rem] tab:mb-[5rem]"> 
                <!-- The :style here is to ensure 100vh is calculated correctly -->
            ...
            <body class="w-[67.42%] mx-auto tab:w-[80%] tab2:w-[90%]">
                <div class="">
                    ...
                    <div class="grid grid-cols-customGrid gap-[2.82rem] mob:grid-cols-1">
                        <article v-for="event in events" :key="event.id" class="">
                        <div class="rounded-t-[1.13825rem]">
                            <img src="@/assets/img/event_img.png" alt="" class="w-full h-full object-contain rounded-t-[1rem]">
                        </div>
