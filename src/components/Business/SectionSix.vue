  ...
  <div class="container pt-[40px] pb-[20px] lg:pt-40 lg:pb-20">
    <div class="w-full">
      <iframe
        ...
        width="auto"
        height="auto"
        src="https://www.youtube.com/embed/S3ySCHITHnc?si=67WAiRkKlv80fa_V"
      ...
      ><button class="animate__bounceOut w-full" @click="changeScreen(0, 1)" v-if="steps[0]">
        <div
          class="w-full lg:h-[600px] h-[28vh] rounded-[14px] overflow-hidden relative"
        >
          <img
            loading="lazy"
            class="h-full w-full"
            src="https://ik.imagekit.io/ldtt3hq8g2/Landing%20Page/2.jpg?updatedAt=1734015110283"
            alt=""
          />
          ...
          <div
            class="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[5rem] h-[5rem]"
          >
            <svg
          ...
          <div
            class="absolute left-[5.34rem] msgTab:left-[2rem] bottom-[3.44rem] msgTab:bottom-[1rem]"
          >
            <h3
              class="text-[#fff] font-Satoshi500 text-[2.06rem] leading-[2.62rem] mob:text-[1.2rem] mob:leading-[1.5rem]"
            >
              MySpurr
            </h3>
            <p
              class="text-left text-[#fff] font-Satoshi400 text-[1rem] leading-[1.28rem] mob:text-[0.8rem]"
            >
              Introduction video
            </p>
          </div>
