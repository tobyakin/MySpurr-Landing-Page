...
<template>
  ...
  <div class="flex flex-col gap-20 mt-20">
    <div class="flex w-[60%] flex-row justify-center mx-auto">
      <button
        class="border-[#254035AB] border-x-[0.769px] border-t-[0.769px] border-b-[0.769px] p-4 py-1 rounded-l-[11.535px] font-Satoshi500 text-[22.521px] items-center flex"
        @click="filterTab('USD')"
        :class="{ 'bg-[#43D0DF] text-white': tab == 'USD' }"
      >
        USD</button
      ><button
        class="border-[#254035AB] border-y-[0.769px] border-r-[0.769px] p-4 py-1 font-Satoshi500 text-[22.521px] items-center flex"
        @click="filterTab('NGN')"
        :class="{ 'bg-[#43D0DF] text-white': tab == 'NGN' }"
      >
        NGN</button
      ><button
        class="border-[#254035AB] border-r-[0.769px] border-y-[0.769px] p-4 py-1 rounded-r-[11.535px] font-Satoshi500 text-[22.521px] items-center flex"
        @click="filterTab('GHS')"
    ...
    <div class="mx-auto flex w-auto justify-center gap-4 lg:gap-8 flex-row items-center">
      <h4 class="lg:text-[26.186px] text-[14px] font-Satoshi500 text-[#000000]">Bill Monthly</h4>
      <div
      ...
      <h4 class="lg:text-[26.186px] text-[14px] font-Satoshi500 text-[#000000]">Bill Yearly</h4>
    </div>
    <div class="grid lg:grid-cols-2 container grid-cols-1 gap-[112px]">
      <div class="border-[#007582] border-[1px] lg:p-[45px] p-[20px] py-[42.27px] rounded-[33px]">
        <h4
        ...
        <div class="flex flex-col gap-2 mt-10">
          <div v-for="item in talentBasic" :key="item" class="flex flex-row items-center gap-2">
            <img loading="lazy" src="@/assets/svg/circleTick.svg" alt="" />
      ...
      <div class="border-[#007582] border-[1px] lg:p-[45px] p-[20px] py-[42.27px] rounded-[33px]">
        ...
        <p class="font-Satoshi400 text-[16px] leading-[31.132px] text-[#000000B2]">For Business</p>
        <div class="flex flex-col gap-2 mt-10">
          <div v-for="item in businessBasic" :key="item" class="flex flex-row items-center gap-2">
            <img loading="lazy" src="@/assets/svg/circleTick.svg" alt="" />
            <h4 class="text-[#000000B2] text-[16px] font-Satoshi400 leading-[31.132px]">
              {{ item.item }}
            </h4>
      ...
      <div class="border-[#007582] border-[1px] lg:p-[45px] p-[20px] py-[42.27px] rounded-[33px]">
        ...
        <h4 class="text-[#2F929C] text-[36px] font-Satoshi700 mt-6 leading-[52.234px]">$5/mo</h4>
        <p class="font-Satoshi400 text-[16px] leading-[31.132px] text-[#000000B2]">
          when billed yearly
        </p>

        <div class="flex flex-col gap-2 mt-10">
          <div v-for="item in talentPro" :key="item" class="flex flex-row items-center gap-2">
            <img loading="lazy" src="@/assets/svg/circleTick.svg" alt="" />
            <h4 class="text-[#000000B2] text-[16px] font-Satoshi400 leading-[31.132px]">
              {{ item.item }}
            </h4>
      ...
      <div class="border-[#007582] border-[1px] lg:p-[45px] p-[20px] py-[42.27px] rounded-[33px]">
        ...
        <h4 class="text-[#2F929C] text-[36px] font-Satoshi700 mt-6 leading-[52.234px]">$10/mo</h4>
        <p class="font-Satoshi400 text-[16px] leading-[31.132px] text-[#000000B2]">
          when billed yearly
        </p>

        <div class="flex flex-col gap-2 mt-10">
          <div v-for="item in businessPro" :key="item" class="flex flex-row items-center gap-2">
            <img loading="lazy" src="@/assets/svg/circleTick.svg" alt="" />
            <h4 class="text-[#000000B2] text-[16px] font-Satoshi400 leading-[31.132px]">
              {{ item.item }}
            </h4>
